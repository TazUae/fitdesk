...
/**
 * Standard error card for failed data fetches.
 *
 * The `message` prop should be the user-safe error string from the action
 * layer — never a raw ERP/HTTP body. Action layer is responsible for
 * scrubbing.
 */
