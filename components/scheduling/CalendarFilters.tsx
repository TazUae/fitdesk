...
/**
 * Calendar filter list in the sidebar.
 *
 * Display-only in Phase 5.0 — toggles flip local state for visual feedback
 * but don't filter anything yet. Wiring to the calendar is Phase 5.3+
