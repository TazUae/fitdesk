 ...
 *
 * 'no_package' renders nothing — the BookingSheet skips this section.
 * 'ok' / 'low' show a small status chip.
 * 'overdraw' shows a strong red warning; the StickyFooter's CTA is also
 *   relabeled to "Confirm package overdraw" and clicking it shows a
 *   confirm dialog before submitting (wired in BookingSheet).
 */
