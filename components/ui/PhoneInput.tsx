...
function formatNational(country: CountryCode, digits: string): string {
  const stripped = digits.replace(/\D/g, '').replace(/^0+/, '')
  if (!stripped) return ''
...
const PHONE_PLACEHOLDERS: Partial<Record<CountryCode, string>> = {
  LB: '71 234 567',  AE: '50 123 4567', SA: '50 123 4567',
  KW: '5000 0000',   QA: '3300 0000',   BH: '3600 0000',
  OM: '9200 0000',   JO: '7 9000 0000', EG: '100 123 4567',
  IQ: '770 123 4567', SY: '944 123 456', YE: '711 234 567',
  TR: '530 123 4567', GB: '7400 123456', US: '201 555 0123',
  CA: '506 234 5678', AU: '412 345 678', DE: '1512 3456789',
  FR: '6 12 34 56 78', ES: '612 345 678', IT: '312 345 6789',
  IN: '81234 56789',  PK: '301 234 5678', SG: '8123 4567',
  MY: '12-345 6789',  NG: '802 123 4567', ZA: '71 234 5678',
  BR: '(11) 91234-5678',
}
